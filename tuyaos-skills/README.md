# tuyaos-skills/ — parked, not maintained

This tree was `skills/TuyaOS/` until **2026-08-17**. It holds two skills
...
from `skills/index.json` (30 → 28 items) and this payload was **moved with
...
`skills/index.json`. De-registering the two items while leaving the payload
...
Don't re-register it into `skills/index.json` — that would put the other
...
`skills/index.json` by a hard-coded path
