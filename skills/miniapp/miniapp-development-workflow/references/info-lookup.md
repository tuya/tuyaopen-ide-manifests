...
`.agents/skills/miniapp-development-workflow/scripts/`；技能内部引用用 `scripts/` 简写。
...
```bash
node .agents/skills/miniapp-development-workflow/scripts/validate.mjs
```

输出形如：

```
[miniapp-development-workflow] validating: /home/.../source/miniapp
