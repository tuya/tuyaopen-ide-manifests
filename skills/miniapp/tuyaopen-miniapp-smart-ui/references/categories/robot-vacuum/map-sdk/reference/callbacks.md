...
- `mapState`: [`MapState`](./types.md#mapstate) - 地图状态信息，包含地图尺寸、原点、充电桩等信息。
...
- `pathState`: [`PathState`](./types.md#pathstate) - 路径状态信息，包含路径ID、类型、机器人位置等。
...
- `rooms`: [`RoomProperty[]`](/references/types#roomproperty) - 房间属性信息数组。
...
- `room`: [`RoomData`](./types.md#roomdata) - 被点击的房间信息。
...
- `type`: `string` - 自定义区域的类型名，通过 [`config.customZoneTypes`](./config.md#customzonetypes) 声明。
...
- `zone`: [`ZoneParam`](./types.md#zoneparam) - 更新后的禁扫区域数据。
...
- `zone`: [`ZoneParam`](./types.md#zoneparam) - 更新后的禁拖区域数据。
...
- `zone`: [`ZoneParam`](./types.md#zoneparam) - 更新后的清扫区域数据。
...
- `type`: `string` - 自定义区域的类型名，通过 [`config.customZoneTypes`](./config.md#customzonetypes) 声明。
- `zone`: [`ZoneParam`](./types.md#zoneparam) - 更新后的自定义区域数据。
...
- `wall`: [`VirtualWallParam`](./types.md#virtualwallparam) - 更新后的虚拟墙数据。
...
- `spot`: [`SpotParam`](./types.md#spotparam) - 更新后的定点清扫数据。
...
- `zone`: [`ZoneParam`](./types.md#zoneparam) - 被点击的禁扫区域数据。
...
- `zone`: [`ZoneParam`](./types.md#zoneparam) - 被点击的禁拖区域数据。
...
- `zone`: [`ZoneParam`](./types.md#zoneparam) - 被点击的清扫区域数据。
...
- `type`: `string` - 自定义区域的类型名，通过 [`config.customZoneTypes`](./config.md#customzonetypes) 声明。
- `zone`: [`ZoneParam`](./types.md#zoneparam) - 被点击的自定义区域数据。
...
- `wall`: [`VirtualWallParam`](./types.md#virtualwallparam) - 被点击的虚拟墙数据。
...
- `spot`: [`SpotParam`](./types.md#spotparam) - 被点击的定点清扫数据。
...
- `furniture`: [`FurnitureParam`](./types.md#furnitureparam) - 更新后的家具数据。
...
- `furniture`: [`FurnitureParam`](./types.md#furnitureparam) - 被点击的家具数据。
...
- `wayPoint`: [`WayPointParam`](./types.md#waypointparam) - 被点击的途径点数据。
...
- `object`: [`DetectedObjectParam`](./types.md#detectedobjectparam) - 被点击的检测物体数据。
...
- `element`: [`CustomElementParam`](./types.md#customelementparam) - 被点击的自定义元素数据。
...
- `carpet`: [`CustomCarpetParam`](./types.md#customcarpetparam) - 更新后的自定义地毯数据。
...
- `divider`: [`Point[]`](/references/types#point) - 更新后的分割线数据。
...
- `point`: [`Point`](./types.md#point) - 点击位置的地图坐标。
...
- `point`: [`IconPoint`](./types.md#iconpoint) - 扫地机器人当前位置和朝向。
...
- `point`: [`IconPoint`](./types.md#iconpoint) - 充电桩当前位置和朝向。
