...
SDK 会根据 [`map.autoPaddingHorizontalPercent`](../reference/config.md#map-autopaddinghorizontalpercent) 和 [`map.autoPaddingVerticalPercent`](../reference/config.md#map-autopaddingverticalpercent) 计算出一个初始的缩放比例，确保地图能够完整显示并保留指定的边距。
...
计算出的初始缩放比例会受到 [`interaction.fitMinScale`](../reference/config.md#interaction-fitminscale) 和 [`interaction.fitMaxScale`](../reference/config.md#interaction-fitmaxscale) 的限制：
...
| 配置项                                                                                   | 默认值 | 说明                         |
| ---------------------------------------------------------------------------------------- | ------ | ---------------------------- |
| [`interaction.fitMinScale`](../reference/config.md#interaction-fitminscale)                   | 1      | 自适应缩放时的最小比例       |
| [`interaction.fitMaxScale`](../reference/config.md#interaction-fitmaxscale)                   | 4      | 自适应缩放时的最大比例       |
| [`map.autoPaddingHorizontalPercent`](../reference/config.md#map-autopaddinghorizontalpercent) | 0.05   | 水平方向保留的最小边距比例   |
| [`map.autoPaddingVerticalPercent`](../reference/config.md#map-autopaddingverticalpercent)     | 0.05   | 垂直方向保留的最小边距比例   |
| [`map.originChangeAutoFitThreshold`](../reference/config.md#map-originchangeautofitthreshold) | 2      | 地图原点变化触发自适应的阈值 |
| [`map.sizeChangeAutoFitThreshold`](../reference/config.md#map-sizechangeautofitthreshold)     | 10     | 地图尺寸变化触发自适应的阈值 |
...
SDK 提供两种颜色分配策略，可通过 [`room.colors.strategy`](../reference/config.md#room-colors-strategy) 配置：
...
在进行颜色分配前，SDK 会先对房间进行排序。排序方式可通过 [`room.colors.sortBy`](../reference/config.md#room-colors-sortby) 配置：
...
| 配置项                                                                     | 默认值       | 说明                                     |
| -------------------------------------------------------------------------- | ------------ | ---------------------------------------- |
| [`room.colors.strategy`](../reference/config.md#room-colors-strategy)           | `'balanced'` | 颜色分配策略（`priority` 或 `balanced`） |
| [`room.colors.sortBy`](../reference/config.md#room-colors-sortby)               | `'index'`    | 房间排序方式（`index` 或 `area`）        |
| [`room.colors.active`](../reference/config.md#room-colors-active)               | 4 种颜色     | `enableRoomSelection: true` 时选中房间的填充色 |
| [`room.colors.inactive`](../reference/config.md#room-colors-inactive)           | 4 种颜色     | `enableRoomSelection: true` 时未选中房间的填充色 |
| [`room.colors.normal`](../reference/config.md#room-colors-normal)               | `undefined`  | `enableRoomSelection: false` 时的填充色（若未定义则使用 `active`） |
| [`room.colors.name`](../reference/config.md#room-colors-name)                   | 4 种颜色     | `enableRoomSelection: true` 时选中房间的文字颜色 |
| [`room.colors.nameNormal`](../reference/config.md#room-colors-namenormal)       | `undefined`  | `enableRoomSelection: false` 时的文字颜色（若未定义则使用 `name`） |
| [`room.colors.propertyTheme`](../reference/config.md#room-colors-propertytheme) | 4 种颜色     | `enableRoomSelection: true` 时选中房间的图标颜色 |
| [`room.colors.propertyThemeNormal`](../reference/config.md#room-colors-propertythemenormal) | `undefined`  | `enableRoomSelection: false` 时的图标颜色（若未定义则使用 `propertyTheme`） |
| [`map.adjacencyThreshold`](../reference/config.md#map-adjacencythreshold)       | `3`          | 房间相邻判定阈值（单位：像素）           |
...
如果当前使用的地图数据是点阵协议的，一般通过 [`decodeRoomProperties`](../reference/utils.md#decoderoomproperties) 方法解析地图数据获取 `roomProperties` 数据。
...
| 配置项 | 默认值 | 说明 |
| --- | --- | --- |
| [`furniture.assets`](../reference/config.md#furniture-assets) | `[内置双人床]` | 家具素材列表 |
| [`furniture.opacity`](../reference/config.md#furniture-opacity) | `1` | 家具图片透明度 |
| [`furniture.rotateDirection`](../reference/config.md#furniture-rotatedirection) | `'cw'` | 旋转方向 |
| [`furniture.minScaleRatio`](../reference/config.md#furniture-minscaleratio) | `0.5` | 最小缩放倍数 |
| [`furniture.maxScaleRatio`](../reference/config.md#furniture-maxscaleratio) | `2` | 最大缩放倍数 |
| [`furniture.iconWrapperFillColor`](../reference/config.md#furniture-iconwrapperfillcolor) | `'#26a69a'` | 编辑按钮颜色 |
...
- 地毯尺寸由 [`controls.carpet.minSize`](../reference/config.md#controls-carpet-minsize)（默认 1 米）和可选的 [`controls.carpet.maxSize`](../reference/config.md#controls-carpet-maxsize)（默认不限制）控制。
- 编辑模式需要同时设置 `config.carpet.enableEdit: true` 和 `runtime.editingCarpetIds`。
- [`controls.carpet.rotateMode`](../reference/config.md#controls-carpet-rotatemode) 默认为 `step`；设置为 `free` 后，旋转按钮改为按住拖动连续旋转。
- [`controls.carpet.scaleMode`](../reference/config.md#controls-carpet-scalemode) 默认为 `ratioLocked`；设置为 `free` 后，右下角按钮改为自由缩放，并隐藏横向、纵向辅助缩放按钮。
:::
...
| 配置 | 默认值 | 说明 |
|------|--------|------|
| [`carpet.src`](../reference/config.md#carpet-src) | 内置资源 | 默认地毯贴图 |
| [`carpet.opacity`](../reference/config.md#carpet-opacity) | `0.5` | 贴图透明度 |
| [`carpet.scale`](../reference/config.md#carpet-scale) | `0.2` | 贴图缩放比例 |
| [`carpet.material`](../reference/config.md#carpet-material) | - | 按类型配置不同贴图素材 |
| [`carpet.enableEdit`](../reference/config.md#carpet-enableedit) | `false` | 是否启用编辑功能 |
| [`controls.carpet.minSize`](../reference/config.md#controls-carpet-minsize) | `1` | 最小尺寸（米） |
| [`controls.carpet.maxSize`](../reference/config.md#controls-carpet-maxsize) | `undefined` | 最大尺寸（米，可选） |
| [`controls.carpet.iconWrapperFillColor`](../reference/config.md#controls-carpet-iconwrapperfillcolor) | `'#5d68fe'` | 非删除按钮背景色 |
| [`controls.carpet.deleteIconWrapperFillColor`](../reference/config.md#controls-carpet-deleteiconwrapperfillcolor) | `'#ff4444'` | 删除按钮背景色 |
| [`controls.carpet.rotateMode`](../reference/config.md#controls-carpet-rotatemode) | `'step'` | 旋转按钮交互模式 |
| [`controls.carpet.scaleMode`](../reference/config.md#controls-carpet-scalemode) | `'ratioLocked'` | 右下角缩放按钮交互模式 |
| [`controls.carpet.fillColor`](../reference/config.md#controls-carpet-fillcolor) | `rgba(93,104,254,0.1)` | 编辑区域填充色 |
