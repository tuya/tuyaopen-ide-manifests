...
**类型**: [`RoomProperty[]`](/references/types#roomproperty)
...
**类型**: [`ZoneParam[]`](/references/types#zoneparam)
...
**类型**: [`VirtualWallParam[]`](/references/types#virtualwallparam)
...
**类型**: [`WayPointParam[]`](/references/types#waypointparam)
...
**类型**: [`DetectedObjectParam[]`](/references/types#detectedobjectparam)
...
**类型**: [`CustomElementParam[]`](/references/types#customelementparam)
...
**类型**: [`CustomCarpetParam[]`](/references/types#customcarpetparam)
...
**类型**: [`FurnitureParam[]`](/references/types#furnitureparam)
