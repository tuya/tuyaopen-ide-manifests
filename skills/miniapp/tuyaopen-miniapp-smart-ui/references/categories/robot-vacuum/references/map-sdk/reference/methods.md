...
**返回值**: [`Promise<CustomCarpetParam[]>`](/references/types#customcarpetparam)
...
**返回值**: [`Promise<boolean>`](./types.md#boolean)
...
**返回值**: [`Promise<ZoneParam[]>`](/references/types#zoneparam)
...
**返回值**: [`Promise<VirtualWallParam[]>`](/references/types#virtualwallparam)
...
**返回值**: [`Promise<SpotParam[]>`](/references/types#spotparam)
...
**返回值**: [`Promise<WayPointParam[]>`](/references/types#waypointparam)
...
**返回值**: [`Promise<Point[] | null>`](/references/types#point) | `null`
...
**返回值**: [`Point[]`](/references/types#point) | `null`
...
**返回值**: [`Promise<Point[]>`](/references/types#point) | `null`
...
- `options.direction`: [`Direction`](./types.md#direction) - 虚拟墙方向，'horizontal' 或 'vertical'，默认为 'horizontal'
- `options.offsetX`: `number` - X方向像素偏移，支持负数，默认为 0
- `options.offsetY`: `number` - Y方向像素偏移，支持负数，默认为 0

**返回值**: [`Promise<Point[]>`](/references/types#point)
...
- `items`: [`FurnitureParam[]`](/references/types#furnitureparam) - 家具数据数组。新 ID 会被添加，已有 ID 的数据变化会被更新，不在列表中的已有 ID 会被移除。传入空数组即清空所有家具。
...
**返回值**: [`Point[]`](/references/types#point)
...
**返回值**: [`Promise<FurnitureParam[]>`](/references/types#furnitureparam)
...
- `points`: [`Point[]`](/references/types#point) - 点坐标数组，支持点/墙体/区域三种类型。
...
- `point`: [`Point`](./types.md#point) - 待检测的点坐标（机器坐标系）

**返回值**: [`Promise<RoomData | null>`](./types.md#roomdata) - 如果点在某个房间内，返回该房间的 RoomData；否则返回 null
...
- `points`: [`Point[]`](/references/types#point) - 墙体的两个端点坐标（机器坐标系）
...
- `points`: [`Point[]`](/references/types#point) - 区域的四个顶点坐标（机器坐标系）
...
**返回值**: [`Promise<string>`](./types.md#string) - Base64 格式的图片数据 (Data URL)。
...
- `data.furnitures`: [`FurnitureParam[]`](/references/types#furnitureparam) - 可选的家具数据
